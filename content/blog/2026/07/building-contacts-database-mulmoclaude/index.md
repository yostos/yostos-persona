...
わが家では、20年に渡って年賀状の住所録管理を[PowerAddress](https://poweraddress.jp/)を使用して管理しています。
...
ところが、2026年5月に「[v5.1 が最後のバージョン、Mac アプリ版は注意が必要](https://poweraddress.jp/final-version-v5-1/)」というアナウンスがPowerAdress
の公式サイトでなされています。
